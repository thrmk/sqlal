...
page_2_graph =html.Div([dbc.Button(html.A("Home", href="/page-2"),outline=True,className="mr-4"),
    ...
    dbc.Button(html.A("SMB Inverter data",href="/page-9"),outline=True,className="mr-4"),
...
def stringtable():
    ...
    row1 = html.Tr([html.Td("String-01"),html.Td("0")])# html.Td(smbdict['str1'])])
    row2 = html.Tr([html.Td("String-02"),html.Td("0")])# html.Td(smbdict['str2'])])
    row3 = html.Tr([html.Td("String-03"),html.Td("0")])# html.Td(smbdict['str3'])])
    row4 = html.Tr([html.Td("String-04"),html.Td("0")])# html.Td(smbdict['str4'])])
    row5 = html.Tr([html.Td("String-05"),html.Td("0")])# html.Td(smbdict['str5'])])
    row6 = html.Tr([html.Td("String-06"),html.Td("0")])# html.Td(smbdict['str6'])])
    row7 = html.Tr([html.Td("String-07"),html.Td("0")])# html.Td(smbdict['str7'])])
    row8 = html.Tr([html.Td("String-08"),html.Td("0")])# html.Td(smbdict['str8'])])
    row9 = html.Tr([html.Td("String-09"),html.Td("0")])# html.Td(smbdict['str9'])])
    row10 = html.Tr([html.Td("String-10"),html.Td("0")])# html.Td(smbdict['str10'])])
    row11 = html.Tr([html.Td("String-11"),html.Td("0")])# html.Td(smbdict['str11'])])
    row12 = html.Tr([html.Td("String-12"),html.Td("0")])# html.Td(smbdict['str12'])])
    row13 = html.Tr([html.Td("String-13"),html.Td("0")])# html.Td(smbdict['str13'])])
    ...
    return table
"""
dbc.Row([dbc.Col([dbc.Row([html.H6("DC Switch"),
daq.Indicator(

  color="#551A8B",
  value=True
)  ,
]),dbc.Row([html.H6("SPD Status"),
daq.Indicator(

  color="#551A8B",
  value=True
)  ,]),]),dbc.Col([dbc.Row([html.H6("DC Voltage"),html.Div("0 v")]),dbc.Row([html.H6("Sum of Currents"),html.Div("0 A")])]),dbc.Row([html.H6("Power"),html.Div("0.000 kw")])])"""

page_9_strings=html.Div([dbc.Row([dbc.Jumbotron([dbc.Container([dbc.Row([dbc.Card([dbc.Col([#html.H6("DC Switch"),
daq.Indicator(
label="DC Switch",
  color="#551A8B",
  value=True
...
dbc.Card(dbc.Col([html.H6("Power"),html.Div("0.000 KW")]))],style={'width':'30rem'})]),html.Table(stringtable()),]),dcc.Link(href='/page-9')])#,style={'width':'55555px'})

#dbc.Container(html.Table(stringtable()))])]),dcc.Link(href='/page-9')])
