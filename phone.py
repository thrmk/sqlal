...
page_4_write=html.Div([ 
    html.H4('Using these you can write the commands for setting the values in the device'),
        ...
        options=[
            ...
            {'label': 'R2', 'value': 'R2'},
            {'label': 'R3', 'value': 'R3'}
        ],     value='',style={"width":"auto"}    ),  html.Div(id="output"),
dbc.Row([ 
    dbc.Col([html.H4("TimeStamp"),
       dbc.Row([ dcc.Input(id="input SEC", type="text"),    dbc.Button("SEC", id="SEC button",style={'backgroundColor':'brown'})]),
       dbc.Row([ dcc.Input(id="input MIN", type="text"),    dbc.Button("MIN", id="MIN button",style={'backgroundColor':'green'})]),

       dbc.Row([  dcc.Input(id="input HOUR", type="text"),    dbc.Button("HOUR", id="HOUR button",style={'backgroundColor':'violet'})]),
      dbc.Row([  dcc.Input(id="input DATE", type="text"),    dbc.Button("DATE", id="DATE button",style={'backgroundColor':'indigo'})]),
       dbc.Row([   dcc.Input(id="input MONTH", type="text"),   dbc.Button("MONTH", id="MONTH button",style={'backgroundColor':'blue'})]),
     dbc.Row([   dcc.Input(id="input YEAR", type="text"),    dbc.Button("YEAR", id="YEAR button",style={'backgroundColor':'yellow'})]),
     html.Br(),dbc.Row([dbc.Button("AUTOMODE", id="AUTOMODE button",style={'backgroundColor':'brown'}), dbc.Button("MANUALMODE", id="MANUALMODE button",style={'backgroundColor':'green'}),dbc.Button("STOP", id="STOP button",style={'backgroundColor':'red'})]),html.Br(),]),
    dbc.Col([
        dbc.Row([html.H4("Location")]),
        dbc.Row([dcc.Input(id="input LAT", type="text"),         dbc.Button("LAT", id="LAT button",style={'backgroundColor':'blue'})]),
        dbc.Row([dcc.Input(id="input LONGITUDE", type="text"),   dbc.Button("LONGITUDE", id="LONGITUDE button",style={'backgroundColor':'brown'})]),
        dbc.Row([ dcc.Input(id="input TIMEZONE", type="text"),dbc.Button("TIMEZONE", id="TIMEZONE button",style={'backgroundColor':'yellow'})]),    
        dbc.Row([html.H4("Tracker Limits")]),
      dbc.Row([  dcc.Input(id="input ELIM", type="text"),     dbc.Button("ELIM/REVLIMIT", id="ELIM button",style={'backgroundColor':'orange'})]),
       dbc.Row([ dcc.Input(id="input WLIM", type="text"),     dbc.Button("WLIM/FWDLIMIT", id="WLIM button",style={'backgroundColor':'violet'})]),
       html.Br(),dbc.Row([dbc.Button("EAST", id="EAST button"), dbc.Button("WEST", id="WEST button",style={'backgroundColor':'purple'})]),html.Br(),]),
     ]),
...
if __name__ == '__main__':
    ...
    app.run_server(debug=True,threaded=True, use_reloader=True,port=8020)
